...
def run_eval(helmet_dir):
    ...
    for hOn in helmet_data:
       ...
       #print(prediction)
        ...
        if status[0:10] != "helmet-off" and confidence >= 97:
            true_count += 1

        elif status[0:10] != "helmet-off" and (face_detected or face_detected_alt) and confidence >= 97:
             false_count += 1
